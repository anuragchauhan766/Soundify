...
function ForgotPassword() {
  ...
  return (
    <div className="w-full  flex  justify-center bg-gradient-to-r from-neutral-800 to-neutral-900 p-8">
      <div className="w-full max-w-3xl  bg-black rounded-xl text-white p-2 sm:p-20 flex flex-col items-center space-y-10">
        <div className="w-full flex items-center justify-center mt-10">
          <img src={logo} alt="soundify-logo" className="w-32 sm:w-60" />
        </div>
        <hr className="w-full  border-t-2 border-t-orange-200 " />
